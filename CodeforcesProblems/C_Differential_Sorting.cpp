    ...
    solution()
    {
        ...
        if (checkIfDecreasing())
        {
            ...
            else
            {
                ...
                {
                    arr[i] = arr[y] - arr[z];
                    indexes.push_back({i, {y, z}});
                }

                cout << indexes.size();
                newline;
                iteratorloop(indexes, i)
                {
                    p(int, pii) index = val(i);
                    cout << index.first + 1;
                    space;
                    cout << index.second.first + 1;
                    space;
                    cout << index.second.second + 1;
                    newline;
                }
            }
        }
