                ...
                if(func == "-"){
                    ...
                    if(order == 1){
                        if(first[A] == 0)
                            ...
                            double x1 = first[A], x2 = first[B];
                            double val1 = (double)(second[A]/x1);
                            double val2 = (double)(second[B]/x2);
                            if(val1 == val2){
                                res = first[A]<first[B];
                            }
                            else{
...
struct solution
{
    ...
    solution()
    {
        ...
        sorting sorter("custom");
        sorter.sortOnBasis(b, c);
